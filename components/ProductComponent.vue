<template>
  <div 
    ...
    class="bg-white inline-block rounded hover:shadow-[0_0_10px_3px_rgba(0,0,0,0.15)]">
            ...
            <img 
                ...
                <div class="ProductDetails">
                    ...
                    <p class="flex items-center px-1 pt-0.5 text-xs text-[#252525]">
                        5,000 + sold <Icon name="material-symbols-light:star" class="ml-1.5" size="20" color="#757575" /> 4.7
                    </p>
...
<script setup>
//     defineProps({
//   // Déclaration des props avec validation
//   product: {
//     type: Object,
//     required: true
//   },
